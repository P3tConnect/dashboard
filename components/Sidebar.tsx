...
const Sidebar = () => {
    ...
    return (
        <div>
            ...
            <div id="application-sidebar" className="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 h-full z-[60] w-64 justify-between bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="px-6">
                ...
                <div className="fixed bottom-4 w-64 overflow-y-auto">
                    <a className="flex items-center gap-x-3.5 py-2 px-2.5 mx-5 text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="javascript:;">
                        <Image width={30} height={30} src="https://i.imgur.com/BxvYFG3.jpg" alt="profile image" className="rounded-full" />
                        Profile
                    </a>
                </div>
            </div>
